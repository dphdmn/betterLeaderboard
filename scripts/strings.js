...
const totalWRsAmount = "Total WRs Amount";
...
const shareCustomRanksText = "Generate and Copy Link for Current Custom Rankings to Clipboard";
...
const customRankingsString = "Custom Rankings of";
...
const lastLeaderboardUpdateString = "Leaderboard is frozen in time. Latest score entry time:";
//const leaderboardUpdatesInfoText = "Thinking it's not updating? It's been more than a day?<br>Click here to see when was the latest commit / message me in discord (dphdmn) / open github issue";
const leaderboardUpdatesInfoText = "<a style=\"color:cyan;font-size: 20px;\"href=\"https://slidysim.github.io\">New Live Leaderboard</a><br>This is the leaderboard as it was on October 1, 2024.<br>You can find this archive and MUCH more <a style=\"color:cyan;\"href=\"https://slidysim.github.io/archive\">here</a>.<br>(with some small exceptions, such as replay data, as of writing this)";
